...
import { useRechargedCoinHistory } from '../../hooks/query';
...
function CoinRechargePage() {
  ...
  return (
    <CoinRechargeTemplate
      coinRecharge={divideArray(data.pages.map((p) => p.body).flat(), 12)[page - 1]}
      page={page}
